...
[Open the app](https://utokyo2026.github.io/linktidy/) · [Download offline HTML](https://github.com/UTokyo2026/linktidy/releases/latest) · [简体中文](README.zh-CN.md)
...
Open the [hosted app](https://utokyo2026.github.io/linktidy/) and click **Try an example**. Or download the HTML from [Releases](https://github.com/UTokyo2026/linktidy/releases/latest), then open it in a modern desktop browser.
